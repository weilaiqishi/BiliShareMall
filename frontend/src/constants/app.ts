...
export const loginModuleRecord: Record<UnionKey.LoginModule, App.I18n.I18nKey> =
  {
    'bili-qrlogin': 'page.login.biliQrlogin.title',
  }
...
export const resetCacheStrategyRecord: Record<
  UnionKey.ResetCacheStrategy,
  App.I18n.I18nKey
> = {
...
export const resetCacheStrategyOptions = transformRecordToOption(
  resetCacheStrategyRecord,
)
