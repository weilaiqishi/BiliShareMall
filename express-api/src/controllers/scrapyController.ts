...
export const addScrapy = (req: Request, res: Response) => {
  try {
    ...
    res.status(200).json({
      message: 'Scrapy item added successfully',
      item: { id: lastInsertRowid, Name, Cookie, searchParams },
    })
  } catch (error: any) {
    res
      .status(500)
      .json({ message: 'Failed to add scrapy item', error: error.message })
  }
}
...
export const getAllScrapyItems = (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({
      message: 'Failed to retrieve scrapy items',
      error: error.message,
    })
  }
}
...
export const getScrapyItemById = (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({
      message: 'Failed to retrieve scrapy item',
      error: error.message,
    })
  }
}
...
export const updateScrapy = (req: Request, res: Response) => {
  try {
    ...
    res
      .status(200)
      .json({ message: 'Scrapy item updated successfully', item: updatedItem })
  } catch (error: any) {
    res
      .status(500)
      .json({ message: 'Failed to update scrapy item', error: error.message })
  }
}
...
export const deleteScrapy = (req: Request, res: Response) => {
  try {
    ...
    res
      .status(200)
      .json({ message: `Scrapy item with ID ${id} deleted successfully` })
  } catch (error: any) {
    res
      .status(500)
      .json({ message: 'Failed to delete scrapy item', error: error.message })
  }
}
...
export const runScrapyTask = (req: Request, res: Response) => {
  try {
    ...
    res
      .status(200)
      .json({ message: `Scrapy task started -> taskId -> `, taskId })
  } catch (error: any) {
    res
      .status(500)
      .json({ message: 'Failed to start scrapy task', error: error.message })
  }
}
...
export const stopScrapyTask = (req: Request, res: Response) => {
  try {
    ...
    res
      .status(500)
      .json({ message: 'Failed to stop scrapy task', error: error.message })
  }
}
...
export const getRunningScrapyTask = (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({
      message: 'Failed to get running scrapy task',
      error: error.message,
    })
  }
}
